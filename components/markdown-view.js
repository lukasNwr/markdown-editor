  ...
  return (
    <>
      <div className="flex flex-col min-h-[calc(100vh-4rem)]">
        ...
        <div className="flex flex-1 overflow-auto break-words max-h-[calc(100vh-6rem)] w-full bg-mainBg p-4 " ref={setMarkdownViewRef} onScroll={handleScroll}>
          <ReactMarkdown
            components={{
